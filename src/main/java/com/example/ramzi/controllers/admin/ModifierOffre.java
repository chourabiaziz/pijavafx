...
public class ModifierOffre {
    ...
    public void initialize(Offre offre) {
        this.offre=offre;
        titreF.setText(offre.getTitre());
        AssuranceF.setText(offre.getAssurance());
        DescriptionF.setText(offre.getDescription());
        EmailF.setText(offre.getEmail_assurance());
        NumF.setText(offre.getNum_assurance());
    }
    ...
    void modifierOffre(ActionEvent event) {
        ...
        if (checktitre() && checkdescription() && checkAssurance() && checkEmail() && checkNum()) {
            this.offre.setTitre(titreF.getText());
            this.offre.setDescription(DescriptionF.getText());
            this.offre.setAssurance(AssuranceF.getText());
            this.offre.setEmail_assurance(EmailF.getText());
            this.offre.setNum_assurance(NumF.getText());

            try {
                offreServices.modifier(this.offre);
