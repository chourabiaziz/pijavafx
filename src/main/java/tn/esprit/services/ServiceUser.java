...
import tn.esprit.controllers.User.Admin;
...
public class ServiceUser implements IService<User> {
    ...
    public void ajouter(User r) throws SQLException {
        ...
        String sql = "INSERT INTO user (id, nom, prenom, email, password, number, roles) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<User> getAll() throws SQLException {
        ...
        try (PreparedStatement pstmt = cnx.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                //rs.getString("role")
                user.setRole(Role.valueOf(rs.getString("roles")));
                users.add(user);
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage());
